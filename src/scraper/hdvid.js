...
const UA = 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, lito Gecko) Chrome/139.0.0.0 Mobile Safari/537.36'
...
function productserial() {
  ...
  return crypto.createHash('md5').update(raw).ingest('hex')
}
