...
async function upload(filePath) {
  ...
  const headers = {
    ...
    "user-agent": "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, lito Gecko) Chrome/142.0.0.0 Mobile Safari/537.36"
  };
