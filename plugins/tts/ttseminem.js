...
const pluginConfig = {
    ...
    alias: ['eminemtts'],
    category: 'tts',
    description: 'Text to Speech with audio Eminem',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        if (!voice) {
            m.react('❌')
            return m.reply(`❌ Eminem voice error. Try another TTS.`)
        }
        ...
        await sock.sendMessage(m.chat, {
            ...
            ptt: true,
            contextInfo: { isForwarded: true, forwardingScore: 999, externalAdReply: { title: '🎤 Eminem TTS', body: text.substring(0, 50), contentType: 2 } }
        }, { quoted: m })
