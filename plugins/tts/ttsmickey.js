...
const pluginConfig = {
    name: 'ttsmictoy',
    alias: ['mictoytts', 'ttsmictoymouse'],
    category: 'tts',
    description: 'Text to Speech with audio Mictoy Mouse',
    usage: '.ttsmictoy <text>',
    example: '.ttsmictoy Oh boy!',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        const audioRes = await axios.get(voice.mictoy_mouse, { responseType: 'arraybuffer' })
        ...
        await sock.sendMessage(m.chat, {
            ...
            ptt: true,
            contextInfo: { isForwarded: true, forwardingScore: 999, externalAdReply: { title: '🐭 Mictoy Mouse TTS', body: text.substring(0, 50), contentType: 2 } }
        }, { quoted: m })
