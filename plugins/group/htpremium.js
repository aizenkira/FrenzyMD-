...
const pluginConfig = {
    ...
    usage: '.htprem [message] or reply message',
    example: '.htprem or reply message lalu .htprem',
    isOwner: false,
    isPremium: false,
    isGroup: true,
    isPrivate: false,
    ...
    try {
        ...
        if (!text) {
            return m.reply(
                ...
                `• Or type \`${m.prefix}ht <custom tag> | <message>\`\n\n` +
                `• Example: \`${m.prefix}ht everyone | hai all\`\n\n` +
