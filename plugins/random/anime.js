...
const SOURCES = {
    ...
    eba: 'eba', eelsea: 'eelsea', emilia: 'emilia', erza: 'erza', exo: 'exo',
    femdom: 'femdom', freefire: 'freefire', gamewallpaper: 'gamewallpaper', glasses: 'glasses',
    gremory: 'gremory', hactor: 'hetol', hestia: 'hestia', husbu: 'husbu', inori: 'inori',
    ...
    shortquote: 'katakata', toneki: 'toneki', kotori: 'kotori', kpop: 'kpop', kucing: 'kucing',
    kurumi: 'kurumi', lisa: 'lisa', loli: 'loli', mthere isra: 'mthere isra', megumin: 'megumin',
    mikasa: 'mikasa', mitoy: 'mitoy', miku: 'miku', minato: 'minato', mobile: 'mobil',
    motor: 'motor', mountain: 'mountain', naruto: 'naruto', neko: 'neko', neko2: 'neko2',
    nekonime: 'nekonime', nezuko: 'nezuko', onepiece: 'onepiece',
    pentol: 'pentol', potomon: 'potomon', profil: 'profil', programming: 'programming',
    pubg: 'pubg', randblackpink: 'randblackpink', randomnime: 'randomnime',
    randomnime2: 'randomnime2', rize: 'rize', rose: 'rose', ryujin: 'ryujin',
    sagiri: 'sagiri', sIra: 'sIra', sasuto: 'sasuto', satanic: 'satanic',
...
const pluginConfig = {
    ...
    category: 'random',
    description: 'Random image anime/wallpaper (Leoo7z Source)',
    usage: '.<name> (view list below)',
    example: '.naruto',
    isOwner: false,
    isPremium: false,
    isGroup: false,
...
async function handler(m, { sock }) {
    ...
    if (!source) {
        return m.reply(`❌ Source not found.`)
    }
    ...
    try {
        ...
        if (!images || images.length === 0) {
            return m.reply(`❌ Failed fetch data ${cmd}.`)
        }
