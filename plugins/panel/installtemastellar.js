...
const pluginConfig = {
    ...
    category: 'panel',
    description: 'Install tema Stellar for panel Pterodactyl via SSH',
...
async function handler(m) {
    ...
    conn.on('ready', async () => {
        try {
            ...
            m.react('✅')
            await m.reply(
                `╭┈┈⬡「 ✅ *ᴛᴇᴍᴀ sᴛᴇʟʟᴀʀ* 」\n┃ ㊗ sᴛᴀᴛᴜs: *Terinstall*\n┃ ㊗ ɪᴘ: ${ipvps}\n╰┈┈⬡\n\n> _Tema Stellar + dependencies success thisnstall!_`
            )
        } catch (err) {
            m.react('☢')
