...
const pluginConfig = {
    ...
    example: '.get https://api.example.com --post --json {"toy":"value"}',
    isOwner: true,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (isBloctodUrl(url)) {
        return m.reply('❌ Localhost / internal address bloctod')
    }
