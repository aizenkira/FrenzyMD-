...
const { getAllPlugins, getCommandsByCategory, getCategories, pluginStore } = require('../src/lib/frenzy-plugins')
        ...
        switch (command) {
            ...
            case "listallcase": {
                try {
                    ...
                    text += `┃ ◦ Category: *${Object.keys(casesByCategory).length}*\n`
                    text += `╰┈┈⬡\n\n`
                    ...
                    text += `*━━━━━━━━━━━━━━━*\n`
                    text += `💡 *ᴛɪᴘ:* Usage \`.listallplugin\` for view plugin`
                    ...
                    await sock.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: 'frenzy Case System',
                                serverMessageId: 127
                            }
                        }
                    }, { quoted: m })
            ...
            case "listallplugin": {
                try {
                    ...
                    if (totalPlugins === 0) {
                        await m.reply('⚠️ *Not yet there is plugin that inmuat*')
                        return { handled: true }
                    }
                    ...
                    text += `*━━━━━━━━━━━━━━━*\n`
                    text += `💡 *ᴛɪᴘ:* Usage \`.listallcase\` for view case`
                    ...
                    await sock.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: '120363406397452589@newsletter',
                                newsletterName: 'frenzy Plugin System',
                                serverMessageId: 127
                            }
                        }
                    }, { quoted: m })
